...
> One AI health product shipped to **4 platforms** (WeChat Mini Program / Android / iOS / HarmonyOS) — architecture, cross-platform core algorithms, LLM integration, and production deployment, end to end.
